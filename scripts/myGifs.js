...
function getSearchGifos(){
    ...
    for (i; i < count; i++){
        ...
        if (subString == "mygif_"){
            ...
            let idGif = data[0].id;
            let titleGif = data[0].title;
            let usernameGif = data[0].user;
            let source = data[0].url;
            let original = data[0].original;
...
function addGif(data, search){
    ...
    if (path == -1){
        div.innerHTML = `<button class="buttonsGif deleteButton" id="deleteButton_${idGif}"><i class="far fa-trash-alt"></i></button>
        ...
        div.innerHTML = `<button class="buttonsGif deleteButton" id="deleteButton_${idGif}"><i class="far fa-trash-alt"></i></i></button>
        <button class="buttonsGif downloadButton" id="downloadButton_${idGif}"><i class="fas fa-download"></i></button>
...
function goViewCreateGif(){
    let path = window.location.pathname.search("myGifsDarkMode");
    let a = document.createElement("a");
    if (path == -1){
